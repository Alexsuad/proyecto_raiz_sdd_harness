...
| **F-020** | Apertura controlada de Fase 2 | Definición de condiciones mínimas para preparar entorno técnico verificable sin desarrollo funcional. | **pendiente** | - | Definir límites y condiciones mínimas | Fase 2 abierta de forma controlada. No implica todavía scripts activos, pytest activo, uv activo, gates ejecutables ni `.agent` activo. |
